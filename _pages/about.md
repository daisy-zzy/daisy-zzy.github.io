...
Prior to CMU, I received my Bachelor's degree with honors in Computer Science and Technology from [Zhejiang University](https://www.zju.edu.cn/english/), where I was advised by [Prof. Jie Yang](https://ylab.top/) at Harvard on large-scale clinical NLP datasets. I also interned at **Alibaba DAMO Academy**, working on multimodal pretraining and inference for medical data under limited modality settings.
